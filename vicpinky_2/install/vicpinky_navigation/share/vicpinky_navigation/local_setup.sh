...
: ${AMENT_CURRENT_PREFIX:="/home/kth/robot_dev/vicpinky_2/install/vicpinky_navigation"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/vicpinky_navigation/environment/library_path.sh"
