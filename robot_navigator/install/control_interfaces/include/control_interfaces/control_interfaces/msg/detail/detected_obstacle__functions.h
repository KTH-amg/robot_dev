...
#ifndef CONTROL_INTERFACES__MSG__DETAIL__DETECTED_OBSTACLE__FUNCTIONS_H_
#define CONTROL_INTERFACES__MSG__DETAIL__DETECTED_OBSTACLE__FUNCTIONS_H_
 ...
 * )) before or use
 * control_interfaces__msg__DetectedObstacle__create()
 ...
 * calls
 * control_interfaces__msg__DetectedObstacle__init().
...
/**
 * It calls
 * control_interfaces__msg__DetectedObstacle__fini()
 ...
 * control_interfaces__msg__DetectedObstacle__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * control_interfaces__msg__DetectedObstacle__Sequence__fini()
 * on the array,
...
#endif  // CONTROL_INTERFACES__MSG__DETAIL__DETECTED_OBSTACLE__FUNCTIONS_H_
