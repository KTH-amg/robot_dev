...
{
  new (message_memory) control_interfaces::msg::DetectedObstacle(_init);
}

void DetectedObstacle_fini_function(void * message_memory)
{
  auto typed_message = static_cast<control_interfaces::msg::DetectedObstacle *>(message_memory);
  typed_message->~DetectedObstacle();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember DetectedObstacle_message_member_array[3] = {
  {
    "x",  // name
    ...
    offsetof(control_interfaces::msg::DetectedObstacle, x),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(control_interfaces::msg::DetectedObstacle, y),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(control_interfaces::msg::DetectedObstacle, yaw),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers DetectedObstacle_message_members = {
  ...
  3,  // number of fields
  sizeof(control_interfaces::msg::DetectedObstacle),
...
get_message_type_support_handle<control_interfaces::msg::DetectedObstacle>()
{
  return &::control_interfaces::msg::rosidl_typesupport_introspection_cpp::DetectedObstacle_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, control_interfaces, msg, DetectedObstacle)() {
  return &::control_interfaces::msg::rosidl_typesupport_introspection_cpp::DetectedObstacle_message_type_support_handle;
}
