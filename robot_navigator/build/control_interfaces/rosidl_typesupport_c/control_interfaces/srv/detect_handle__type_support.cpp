...
static const _DetectHandle_Request_type_support_symbol_names_t _DetectHandle_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, control_interfaces, srv, DetectHandle_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, control_interfaces, srv, DetectHandle_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, control_interfaces, srv, DetectHandle_Request)() {
  return &::control_interfaces::srv::rosidl_typesupport_c::DetectHandle_Request_message_type_support_handle;
}
...
static const _DetectHandle_Response_type_support_symbol_names_t _DetectHandle_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, control_interfaces, srv, DetectHandle_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, control_interfaces, srv, DetectHandle_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, control_interfaces, srv, DetectHandle_Response)() {
  return &::control_interfaces::srv::rosidl_typesupport_c::DetectHandle_Response_message_type_support_handle;
}
...
static const _DetectHandle_Event_type_support_symbol_names_t _DetectHandle_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, control_interfaces, srv, DetectHandle_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, control_interfaces, srv, DetectHandle_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, control_interfaces, srv, DetectHandle_Event)() {
  return &::control_interfaces::srv::rosidl_typesupport_c::DetectHandle_Event_message_type_support_handle;
}
...
static const _DetectHandle_type_support_symbol_names_t _DetectHandle_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, control_interfaces, srv, DetectHandle)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, control_interfaces, srv, DetectHandle)),
  }
};
...
static const rosidl_service_type_support_t DetectHandle_service_type_support_handle = {
  ...
  &DetectHandle_Request_message_type_support_handle,
  &DetectHandle_Response_message_type_support_handle,
  &DetectHandle_Event_message_type_support_handle,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, control_interfaces, srv, DetectHandle)() {
  return &::control_interfaces::srv::rosidl_typesupport_c::DetectHandle_service_type_support_handle;
}
