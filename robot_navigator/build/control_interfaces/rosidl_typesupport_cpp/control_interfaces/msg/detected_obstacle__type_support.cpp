...
static const _DetectedObstacle_type_support_symbol_names_t _DetectedObstacle_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, control_interfaces, msg, DetectedObstacle)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, control_interfaces, msg, DetectedObstacle)),
  }
};
...
{
  return &::control_interfaces::msg::rosidl_typesupport_cpp::DetectedObstacle_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, control_interfaces, msg, DetectedObstacle)() {
  return get_message_type_support_handle<control_interfaces::msg::DetectedObstacle>();
}
