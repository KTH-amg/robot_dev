...
void printUsageInstructions() {
    std::cout << "\n=== Simple Central Server with Nearest Waypoint Start Point ===" << std::endl;
...
int main(int argc, char** argv)
{
    ...
    try {
        ...
        RCLCPP_INFO(g_server->get_logger(), "Simple Central Server with Nearest Waypoint Start Point");
        RCLCPP_INFO(g_server->get_logger(), "==========================================================");
